...
if (!isset($_SESSION['tampil_kebutuhan'])) {
    $_SESSION['tampil_kebutuhan'] = false; // Default: Sembunyikan
}

// --- LOGIKA TOGGLE ---
if (isset($_GET['toggle']) && $_GET['toggle'] == 'kebutuhan') {
...
$tampilkan_tabel_kebutuhan = $_SESSION['tampil_kebutuhan'] ?? false;


if ($tampilkan_tabel_kebutuhan) {
    // Panggil fungsi yang baru kita buat untuk mengambil data
    $daftar_kebutuhan = getKebutuhanList($DBH); 
}
 ?>